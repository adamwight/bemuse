...
function list_books($where)
{
    ...
    echo "<h2>Publicized Books</h2>";
    $printer->print_favorite_books($where);

    echo "<h2>Public books</h2>";
    $printer->print_public_books($where);

    echo "<h2>Private collection</h2>";
    $printer->print_private_books($where);
}
